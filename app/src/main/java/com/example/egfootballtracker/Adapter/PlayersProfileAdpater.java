...
public class PlayersProfileAdpater extends RecyclerView.Adapter<PlayersProfileAdpater.TestViewHolder> {
    ...
    public PlayersProfileAdpater(Context context, List<PlayerDetails> playerDetails){
    ...
    public void onBindViewHolder(@NonNull TestViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        PlayerDetails playerDetailsNew = playerDetailsList.get(position);
